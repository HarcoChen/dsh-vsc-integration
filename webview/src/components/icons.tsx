...
export function PlayIcon({ size = 12 }: IconProps): React.JSX.Element {
    return (
        <svg {...base(size)} fill="currentColor" stroke="none">
...
export function KeyIcon({ size = 12 }: IconProps): React.JSX.Element {
    return (
        <svg {...base(size)}>
            <circle cx="5.5" cy="5.5" r="3" />
            <path d="M7.8 7.8 13.5 13.5M11 11l1.8-1.8M12.8 12.8l1.2-1.2" />
        </svg>
    );
}

export function LogIcon({ size = 12 }: IconProps): React.JSX.Element {
    return (
        <svg {...base(size)}>
...
export function ExternalLinkIcon({ size = 12 }: IconProps): React.JSX.Element {
    return (
        <svg {...base(size)}>
...
export function TraceIcon({ size = 12 }: IconProps): React.JSX.Element {
    return (
        <svg {...base(size)}>
            <path d="M1.5 8h3l1.8-4.5L9.8 12 11.5 8h3" />
        </svg>
    );
}
