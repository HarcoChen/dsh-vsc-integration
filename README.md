...
> - Review structured Web Search sources and Web Fetch status with Host-validated external links
> - Navigate LSP definitions, references and implementations, and inspect Hover results in tool cards
